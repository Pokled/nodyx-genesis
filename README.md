...
**w8**, graine 51, ajoute la reproduction d'organisme (`split_enabled` + `split_gene`) à toute
la pile de w7, dès la genèse : un organisme assez grand se scinde en deux, chacun avec son nom,
et chacun porte son propre seuil hérité de scission (`BIBLE/experiments/021` et `022`). C'est le
premier monde où une identité qui persiste devient une identité qui se multiplie. Tenu en
direct sur `--port 8084`.
