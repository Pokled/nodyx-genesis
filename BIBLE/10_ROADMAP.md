...
| 0.0.3 | Individus | Mémoire, personnalité, besoins, objectifs, relations, comportement. **Cible probante.** Toujours sans LLM. **Démarré :** tranche 1, le premier souvenir (éveil Entity vers Agent, mémoire épisodique qui biaise le déplacement, A/B graine 3 : morts par famine -15 %) ; tranche 2, `lives.html`, la première biographie auto-générée (prose de gabarits, aucun LLM, `05_COGNITION.md`). Reste : besoins, personnalité héritée, souvenirs ancrés, comportement complet | La première biographie auto-générée (`lives.html`, forme minimale en place) | Le comportement dépend-il vraiment du souvenir, ou est-ce cosmétique ? Substrat cognitif semé ou évolutif ? (voir `05_COGNITION.md`) |
