...
| 0.0.3 | Individus | Mémoire, personnalité, besoins, objectifs, relations, comportement. **Cible probante.** Toujours sans LLM. **Démarré :** tranche 1, le premier souvenir (éveil Entity vers Agent, mémoire épisodique spatiale qui biaise le déplacement, `05_COGNITION.md`). A/B graine 3 : morts par famine -15 %. Reste : besoins, personnalité héritée, souvenirs ancrés, page biographie, comportement complet | La première biographie auto-générée | Le comportement dépend-il vraiment du souvenir, ou est-ce cosmétique ? Substrat cognitif semé ou évolutif ? (voir `05_COGNITION.md`) |
