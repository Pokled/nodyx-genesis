...
| 0.0.4 | Voix | Signaux, langage émergent, groupes, transmission. **Démarré :** t1 le premier signal (`WorldState.signals`, schéma v14) : un agent affamé émet une alarme, les agents proches ont un sursaut de peur, aucun lexique. A/B graine 1 : famine -10 %, diversité +37 % (la panique alerte et disperse). | Deux populations isolées qui divergent linguistiquement | Un système de signes émerge-t-il sans qu'on code un lexique ? |
