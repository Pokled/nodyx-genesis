...
- **Jalon 0.0.3 « Individus » DEMARRE, tranches 1 a 6 faites (2026-09-01)** :
  ...
  - Detail : `05_COGNITION.md`. **`worlds/w2` = graine 1 depuis v10** (graine 3 non viable apres le decalage RNG). Reste 0.0.3 : souvenirs sociaux, de-simulation de la biologie ; et le modele de temps a deux horloges (`04_SIMULATION.md`).
