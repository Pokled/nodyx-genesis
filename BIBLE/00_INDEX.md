...
- **Jalon 0.0.3 « Individus » DEMARRE, tranches 1 a 8 faites (2026-09-01 / 09-02)** :
  ...
  - Detail : `05_COGNITION.md`. **`worlds/w2` = graine 1 depuis v10** (graine 3 non viable apres le decalage RNG). Reste 0.0.3 : rien de structurel (cible probante atteinte) ; ensuite 0.0.4 « Voix » ou le modele de temps a deux horloges (`04_SIMULATION.md`).
